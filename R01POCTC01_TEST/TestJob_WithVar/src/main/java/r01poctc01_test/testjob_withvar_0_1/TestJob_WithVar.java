...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "zqgCW0_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TestJob_WithVar' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-01-14T08:53:33.753229900Z");
...
/************************************************************************************************
 *     86438 characters generated by Talend Cloud Data Fabric 
 *     on the 2025年1月14日 17:53:33 JST
 ************************************************************************************************/
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "RlrskT_" + subJobPidCounter.getAndIncrement());
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tHttpRequest_1{
                    ...
                    log4jParamters_tHttpRequest_1.append("Parameters:");
                        ...
                        log4jParamters_tHttpRequest_1.append(" | ");
                            log4jParamters_tHttpRequest_1.append("OUT_FILE_NAME" + " = " + "\"C:/Users/R01POCTC01ADMIN2/Desktop/work/after/In/\"+context.compcode+\"_apioutput.csv\"");
                        log4jParamters_tHttpRequest_1.append(" | ");
                        ...
                        log4jParamters_tHttpRequest_1.append(" | ");
                            log4jParamters_tHttpRequest_1.append("DIE_ON_ERROR" + " = " + "false");
                        log4jParamters_tHttpRequest_1.append(" | ");
...
try{
    ...
    if ( responseCode_tHttpRequest_1 >= 200 && responseCode_tHttpRequest_1 < 300) { //Status code 2XX indicates success
        java.io.InputStream bis_tHttpRequest_1 = new java.io.BufferedInputStream(urlConn_tHttpRequest_1.getInputStream());
            java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(new java.io.FileOutputStream("C:/Users/R01POCTC01ADMIN2/Desktop/work/after/In/"+context.compcode+"_apioutput.csv"));
        ...
        if(err_stream_tHttpRequest_1!=null) {
        	...
        	responseMessage_tHttpRequest_1 += ("\n" + new String(baos_tHttpRequest_1.toByteArray()));
                ...
                log.error("tHttpRequest_1 - " + responseCode_tHttpRequest_1 + " " + responseMessage_tHttpRequest_1);
...
globalMap.put("tHttpRequest_1_ERROR_MESSAGE",e.getMessage());
            log.error("tHttpRequest_1 - " + e.getMessage());
        System.err.println(e.getMessage());
}
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TestJob_WithVar' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-01-14T08:23:06.857592Z");
...
/************************************************************************************************
 *     86345 characters generated by Talend Cloud Data Fabric 
 *     on the 2025年1月14日 17:23:06 JST
 ************************************************************************************************/